...
| `IdleSleepTimeoutMinutes` | Int | Determines the number of minutes of user inactivity before the system automatically goes to sleep. | Required when `SetPowerPolicies` is used. Valid range: 30-1440 minutes. See [Idle Timeout Dependencies](#idle-timeout-dependencies) below for ordering requirements. [^5] |
...
**Table 4:** Idle Timeout Parameter Dependencies
